...
| 设置         |                                  |                                                            |
| ------------ | -------------------------------- | ---------------------------------------------------------- |
| 识别模式     | `fast` (默认“快速”) | `accurate` | 自由设置在脸部识别中的速度或者准确率。                     |
| 识别特征点   | `none` (默认“无”) | `all`        | 是否尝试去辨认脸上的特征点：眼睛，耳朵，鼻子，脸颊，嘴巴。 |
| 辨认脸部     | `none` (默认“无”) | `all`        | 是否将脸分类成“睁开眼睛”或者“微笑”。                       |
| 脸部最小识别 | `CGFloat` (默认： `0.1`)         | 最小识别多大的脸部，与照片大小有关。                       |
